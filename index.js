...
const onMovieSelect = async (movie, summaryElement, side) => {
    ...
    // Condition for when to compare both summaries
    if (side === "left") {
...
const runComparison = () => {
    ...
    // iterate over pair and compare dataset values
...
const movieTemplate = (movieDetail) => {
    // Generate a number representation of box office value so we can compare
